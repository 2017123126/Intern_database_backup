...
### [[consumer products]DAU divided by MAU](https://andrewchen.com/zero-to-productmarket-fit-presentation/)

You want to see DAU/MAU at >25%. A world-class leading DAU/MAU would be over 50%.

### [[consumer products]Organic growth](https://andrewchen.com/zero-to-productmarket-fit-presentation/)

You want to see hundreds if not thousands of signups per day.

### [[consumer products]Active day](https://andrewchen.com/zero-to-productmarket-fit-presentation/)

30% of users are active the day after signup. >70% would be world-class there.

### [[consumer products]DAU](https://andrewchen.com/zero-to-productmarket-fit-presentation/)

100,000 DAU

### [[SaaS products]Conversion rate](https://andrewchen.com/zero-to-productmarket-fit-presentation/)

5% conversion rate from free-to-paid 

### [[SaaS products]CPA divided by LTV](https://andrewchen.com/zero-to-productmarket-fit-presentation/)

3X CPA to LTV ratio

### [[SaaS products]monthly churn rate](https://andrewchen.com/zero-to-productmarket-fit-presentation/)

<2% monthly churn rate

### [[SaaS products]MRR](https://andrewchen.com/zero-to-productmarket-fit-presentation/)

Clear path to $100k MRR(Monthly Recurring Revenue)

### [Sean Ellis Test](https://userpilot.com/blog/pmf-survey/)

A product-market fit survey measures your PMF by asking your customers for their feedback on your product. This survey is carried out by asking customers how they would feel if they could no longer use your product. (Sean Ellis test)

Sean Ellis test works because it’s based on a simple [survey question](https://userpilot.com/blog/in-app-survey-questions-saas/): “How would you feel if you could no longer use this product?”

Sean Ellis split the survey responses into three tiers:

- Very disappointed
- Somewhat disappointed
- Not disappointed

In Sean Ellis’ opinion, the one response that matters most is the “very disappointed” tier. Ellis discovered that companies that had less than 40% of users answer “very disappointed” often struggled to find growth. Thus, he chose 40% as his magic number for measuring PMF.